...
class Sidebar(ft.Container):
            ...
            [
                ft.Column(
                    [
                        ...
                        self._build_expansion_tile(i18n.t("sidebar.date_time"), ft.Column([self.layout.start_controls, self.layout.end_controls]), data="datetime"),
                        ...
                        # Estadísticas
                        self._build_expansion_tile(i18n.t("table.stats_title"), self.layout.stats_column, data="stats"),
                    ],
                    spacing=5,
    ...
    def _build_expansion_tile(self, title, controls_col, data=None):
        """
